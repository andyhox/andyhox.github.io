...
![Materials Project_login](Learn-VASP-from-pymatgen-3-学会使用Materials-project/0_MP_login.png)

登录后进入主页，开始今天的MP学习之旅。

![MP_home](Learn-VASP-from-pymatgen-3-学会使用Materials-project/1_MP_homepage.png)
...
![MP_search_type](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/3_MP_search_type.png)
...
![MP_search_Si](Learn-VASP-from-pymatgen-3-学会使用Materials-project/4_MP_Si.png)
...
![MP_Si_info1](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/5_MP_Si_info1.png)

继续往下拉还可以看到具体的晶格常数信息，能带态密度图、模拟光谱信息等。

- 晶格常数信息

![MP_Si_info2](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/6_MP_Si_info2.png)

- 能带态密度图

![MP_Si_info3](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/7_MP_Si_info3.png)

- 模拟光谱

![MP_Si_info4](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/8_MP_Si_info4.png)
...
![MP_API_key](Learn-VASP-from-pymatgen-3-学会使用Materials-project/2_MP_api_key.png)
...
![mp_api_install](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/9_mp_api_install.png)
...
![MP_API_Si_structure](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/10_case1.png)
...
![MP_API_search_fields](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/11_search_details.png)
...
![MP_print_docs](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/12_prindocs.png)
...
![MP_API_Si_structure_df](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/13_Si.png)
...
![contain_SiO](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/14_contain_SiO.png)
...
![contain_SiO_num2](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/15_contain_SiO_num2.png)
...
![contain_SiO_3](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/16_contain_SiO_3.png)
...
结果如下，可以自行对照检验：
![ex1_result](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/17_ex1_results.png)
...
![export_csv](Learn-VASP-from-pymatgen-3-学会使用Materials-project/chap3/18_csv_result.png)
