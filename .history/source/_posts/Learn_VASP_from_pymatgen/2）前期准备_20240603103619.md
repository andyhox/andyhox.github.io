...
![Linux_version 安装包](/images/Learn_VASP_from_pymatgen/chap2/1_linux_pkg.png)
...
### 验证Miniconda是否安装成功
	...
	```
如果安装成功，会显示conda的版本号。
![Linux_version conda版本](/images/Learn_VASP_from_pymatgen/chap2/2_check_miniconda_installation.png)
...
![Linux_version conda环境列表](/images/Learn_VASP_from_pymatgen/chap2/3_conda_env_list.png)
...
![Linux_version conda环境列表](/images/Learn_VASP_from_pymatgen/chap2/4_activate_my_pymatgen.png)
...
![Linux_version pymatgen安装成功](/images/Learn_VASP_from_pymatgen/chap2/5_check_pymatgen_installation.png)
...
```
出现如下信息，说明配置成功。
![Linux_version pymatgen配置成功](/images/Learn_VASP_from_pymatgen/chap2/6_check_pmg_potential.png)
