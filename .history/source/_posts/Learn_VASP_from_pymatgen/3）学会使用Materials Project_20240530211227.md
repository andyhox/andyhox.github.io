...
对于自学的各位来说，自我检验计算能力的方法就是看自己算的跟别人算的结果是不是一样，可能有人会说直接找一篇有计算的文献复现一下就行了。但是，很遗憾，目前绝大多数的文献`Computational Method`部分的撰写都是比较简略的，对于新手小白来说，只阅读文字很难从里面提炼出一个与作者差不多的INCAR设置，更不用说具体计算的结构模型
