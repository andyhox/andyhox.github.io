...
![MP_search_type](Learn-VASP-from-pymatgen-3-学会使用Materials-project/3_MP_search_type.png)
...
![MP_Si_info1](Learn-VASP-from-pymatgen-3-学会使用Materials-project/5_MP_Si_info1.png)

继续往下拉还可以看到具体的晶格常数信息，能带态密度图、模拟光谱信息等。

- 晶格常数信息

![MP_Si_info2](Learn-VASP-from-pymatgen-3-学会使用Materials-project/6_MP_Si_info2.png)

- 能带态密度图

![MP_Si_info3](Learn-VASP-from-pymatgen-3-学会使用Materials-project/7_MP_Si_info3.png)

- 模拟光谱

![MP_Si_info4](Learn-VASP-from-pymatgen-3-学会使用Materials-project/8_MP_Si_info4.png)
...
![mp_api_install](Learn-VASP-from-pymatgen-3-学会使用Materials-project/9_mp_api_install.png)
...
![MP_API_Si_structure](Learn-VASP-from-pymatgen-3-学会使用Materials-project/10_case1.png)
...
![MP_API_search_fields](Learn-VASP-from-pymatgen-3-学会使用Materials-project/11_search_details.png)
...
![MP_print_docs](Learn-VASP-from-pymatgen-3-学会使用Materials-project/12_prindocs.png)
...
![MP_API_Si_structure_df](Learn-VASP-from-pymatgen-3-学会使用Materials-project/13_Si.png)
...
![contain_SiO](Learn-VASP-from-pymatgen-3-学会使用Materials-project/14_contain_SiO.png)
...
![contain_SiO_num2](Learn-VASP-from-pymatgen-3-学会使用Materials-project/15_contain_SiO_num2.png)
...
![contain_SiO_3](Learn-VASP-from-pymatgen-3-学会使用Materials-project/16_contain_SiO_3.png)
...
结果如下，可以自行对照检验：
![ex1_result](Learn-VASP-from-pymatgen-3-学会使用Materials-project/17_ex1_results.png)
...
![export_csv](Learn-VASP-from-pymatgen-3-学会使用Materials-project/18_csv_result.png)
